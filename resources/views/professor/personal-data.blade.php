    ...
    <form id="form" name="{{ route('professorPersonalData') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <input name="last_name" id="textSobrenome" class="form-control" type="text" value="{{ old('last_name') }}"
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <input name="name_mother" id="inputNomeMae" class="form-control" type="text" value="{{ old('name_mother') }}"
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <input name="rg_number" type="text" class="form-control" id="inputNumDocs" value="{{ old('rg_number') }}"
            ...
            <div class="col-md-2">
                ...
                <input name="uf_issue" type="text" class="form-control" id="inputOrgEmissor" value="{{ old('uf_issue') }}"
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <input name="postal_code" type="text" class="form-control" id="inputCep" value="{{ old('postal_code') }}"
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <input name="number" type="text" class="form-control" id="inputNum" required value="{{ old('number') }}"
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <input name="phone" type="text" class="form-control" id="inputNum_1" value="{{ old('phone') }}"
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <input name="mobile" type="text" class="form-control" id="inputNum_1" value="{{ old('mobile') }}"
