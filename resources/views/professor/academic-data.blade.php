            ...
            <div  class="row">
                <div class="col-md-7">
                    <div  class="form-group">
                        ...
                        <input maxlength="255" required  type="text" class="form-control" id="cadlettters" name="cadlettters" placeholder="links para o curriculo lattes" value="{{ old('cadlettters') }}">
                    </div>
                </div>
            </div>
            <br />
