  ...
  <head>
	...
	<div class="container">
		...
		<table class="table">
			...
			<tbody>
				<tr>
					...
					<td>reoferta</td>
					<td>Refazer</td>
					<td><button type="button" class="btn btn-danger">Aplicar</button></td>
				</tr>
				<tr>
					<td>Física III</td>
					<td>80</td>
		...
		<nav aria-label="Page navigation">
			<ul class="pagination">
				<li>
					<a href="processos-seletivos4.html" aria-label="Previous">
					...
					<li>
						<a href="processos-seletivos6.html" aria-label="Next">
